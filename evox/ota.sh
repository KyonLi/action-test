...
custota-tool gen-csig --input "$filename" --key testkey.key --cert testkey.x509.pem --cert-verify otacert --output "$filename.csig"
custota-tool gen-update-info --file pstar.json --location "$download" --csig-location "https://raw.githubusercontent.com/KyonLi/action-test/master/evox/$filename.csig"
